...
func should_be_solid(color: Color) -> bool:
	...
	var base_background_color = background.modulate
	var filtered_background_color = Color(
		base_background_color.r * ColorFilterManager.get_current_filter().r,
		base_background_color.g * ColorFilterManager.get_current_filter().g,
		base_background_color.b * ColorFilterManager.get_current_filter().b,
